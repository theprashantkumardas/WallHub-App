        ...
        renderItem={({ item }) => {
          ...
          return (
            <CategoryListItem
              category={item}
              onPress={() => {
                console.log("Navigating with path:", pathWithParams); // Log before push
                router.push(pathWithParams as Href);
              }}
            />
          );
        }}
...
//       <Stack.Screen options={{ title: 'Category Placeholder' }} />
//       <Text>Category Tab Content</Text>
//     </View>
//   );
// }
